...
locators = LocatorDict({
    ...
    "resource.vm.power_button": (
        ...
        "//table[contains(@id, 'DataTables')]//a[contains(@data-id, '%s') and .='%s']/../../td[6]//a"),
    "resource.vm.delete_button_dropdown": (
        By.XPATH,
        #"//table[contains(@id, 'DataTables')]//a[contains(@data-id, '%s') and .='%s']/../../td[5]//a[2]"),
        "//table[contains(@id, 'DataTables')]//a[contains(@data-id, '%s') and .='%s']/../../td[6]//a[2]"),
    ...
    "resource.image.operatingsystem": (By.XPATH, "//select[@id='image_operatingsystem_id']"),
    "resource.image.architecture": (By.XPATH, "//select[@id='image_architecture_id']"),
    "resource.image.username": (By.ID, "image_username"),
    "resource.image.password": (By.ID, "image_password"),
    #"resource.image.image": (By.XPATH, "//select[@id='image_uuid']"),
    "resource.image.image": (By.XPATH, "//input[@id='image_uuid']"),
    "resource.image.submit": (By.XPATH, "//input[@data-id='aid_create_image']"),
